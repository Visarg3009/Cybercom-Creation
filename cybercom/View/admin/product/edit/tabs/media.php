...
<form action="<?php echo $this->getUrl()->getUrl('save','admin\Product\Media');?>" method="post" id="upload" enctype="multipart/form-data">    
    ...
    <table class="table table-striped table-hover table-bordered mt-5">
        ...
        <?php foreach ($data->data as $key=>$value) {?>
            <tr>
                <td><img src="./Images/Product/<?php echo $value->name; ?>" alt="" hight="100px" width="100px"></td>
                <td><input type="text" value="<?php echo $value->name; ?>" name="image[data][<?php echo $value->image_Id;?>][name]"></td>
                <td>
