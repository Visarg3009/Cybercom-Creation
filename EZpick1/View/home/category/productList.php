...
<div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
    ...
    <div class="aa-product-catg-body">
        ...
        <?php foreach($products->getData() as $key => $product): ?>
            <li>
            <figure>
            <a class="aa-product-img" href="<?= $this->getUrl()->getUrl('view','ProductDetail',['id'=>$product->product_id]);?>"><img src="./Images/Product/<?php echo $product->image_name; ?>" alt="polo shirt img"></a>
            ...
            <figcaption>
                <h4 class="aa-product-title"><a href="<?= $this->getUrl()->getUrl('view','ProductDetail',['id'=>$product->productId]);?>"><?= $product->name;?></a></h4>
