<?php
namespace Controller\Seller\Product;
...
class GroupPrice extends \Controller\Core\Admin
{
    ...
    {
        try{
            $grid = \Mage::getBlock('Block\Seller\Product\Edit\Tabs\GroupPrice');
    ...
    {
        try {
            $form = \Mage::getBlock('Block\Seller\Product\Edit\Tabs\GroupPrice');
            $contentHtml = $form->toHtml();

            $tab = \Mage::getBlock('Block\Seller\Product\Edit\Tabs');
            $leftHtml = $tab->toHtml();
